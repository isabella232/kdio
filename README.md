# kd-io: yet another kd.js project

## Getting Started

After cloning the repo, cd into `kd-io` directory and do;
...
This will open your browser with `localhost:9000` and you should see the `kd-io` project alive \o/
